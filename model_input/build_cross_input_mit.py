...
def get_train_data(name_list,flag):
    ...
    this_root_path = os.path.join(f'/mnt/data1/user/zzp/medic_data/mit_pkl_data/1018_single/{flag}_2')
    arr_list = []
    for name in name_list:
        abs_path = os.path.join(this_root_path,f'chb{name}_{flag}_array.pkl')
        #print(abs_path)
...
class CNN_INPUT_cross_identity():
    def __init__(self, config):
        ...
        self.train_name_list = ['01', '02', '03', '04', '05',
                                '06', '07', '08', '09', '10', '11', '12', '13', '14',
                                '15', '16', '18', '19', '20', '21', '22']

        self.test_name_list = ['23', ]  # ['23', ]
