...
def get_train_data(name_list,flag):
    ...
    this_root_path = os.path.join(f'/data/zzp/mit_pkl_data/1018_single/{flag}')
    arr_list = []
...
class CNN_INPUT_cross_fine_tune():
    def __init__(self, config):
        ...
        self.train_name_list = ['chb01', 'chb02', 'chb03', 'chb04', 'chb05',
                                'chb06', 'chb07', 'chb08', 'chb09', 'chb10', 'chb11', 'chb12', 'chb13', 'chb14', 'chb15',
                                'chb16', 'chb18', 'chb19', 'chb20', 'chb21', 'chb22'
                                # '17',
                                ]
        self.test_name_list = ['chb23', ]
...
class CNN_INPUT_cross_identity():
    def __init__(self, config,trainST,testST):
        self.config = config 
        ...
        self.train_name_list =trainST
        self.test_name_list =testST
        self.test_num = len(self.test_name_list)
