...
class CW_SRNet(nn.Module):
    ...
    def __init__(self, block, layers, identiClasses, num_classes=2, zero_init_residual=False,
...
def cw_srnet(identiClasses,num_classes=2):
    """Constructs a ResNet-18 model.

    Args:
        pretrained (bool): If True, returns a model pre-trained on ImageNet
    """
    model = CW_SRNet(SEBasicBlock, [2, 2, 2, 2], identiClasses=identiClasses,num_classes=num_classes)
