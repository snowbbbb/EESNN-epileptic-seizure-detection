...
class SNNIDEConvMultiLayerNet(nn.Module):
    ...
    def __init__(self, cfg, **kwargs):
        ...
        self.network_s5 = SNNConvTranspose(self.c_s4, self.c_hidden, bias=False, dropout=self.dropout, kernel_size=3, stride=(2,1), padding=1, output_padding=(1,0))
        ...
        self.classifier = nn.Linear(344064 , self.num_classes, bias=True)#6400, self.num_classes, bias=True)#reshape结构
        
        
        self.classifier2 = nn.Sequential(  #domain adversary domain classifier
          nn.Linear(344064 , 100),#6400,100),#reshape结构
          nn.BatchNorm1d(100),
          nn.ReLU(True),
