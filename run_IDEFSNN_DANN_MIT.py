...
from model_input.build_cross_input_mit5s_noFT import CNN_INPUT_noFT, CNN_INPUT_cross, CNN_INPUT_cross_fine_tune,CNN_INPUT_cross_gaussian,CNN_INPUT_cross_identity
...
def run_train(model, optimizer, use_eval=1):
    ...
    for i in range(EPOCHS):
        ...
        accuracy, precision, recall, specificity, train_auc, train_loss, tmp_model = train_once_DANN(model, optimizer,
                                                                                                     optimizer2,
                                                                                                     train_iterator,
                                                                                                     CNN_Data_identity.train_loader,
                                                                                                     len_dataloader,
                                                                                                     params, i)
...
if __name__ == '__main__':
    ...
    with torch.cuda.device(cuda_id):
        ...
        config['MODEL']['h_hidden'] = 160
        config['MODEL']['w_hidden'] = 11
        ...
        #best_pretrain_model_path = '/data/zzp/result/model_save/mit/resnet_scale0_epoch49of50_11232143.pkl'
