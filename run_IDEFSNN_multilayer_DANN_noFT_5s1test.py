...
from model_input.build_cross_input_beiyi5s_noFT import CNN_INPUT_cross, CNN_INPUT_cross_fine_tune,CNN_INPUT_cross_gaussian,CNN_INPUT_cross_identity
...
if __name__ == '__main__':
    ...
    with torch.cuda.device(cuda_id):
       ...
       # best_pretrain_model_path = '/data/zzp/result/model_save/mit/resnet_scale0_epoch0of50_01300923.pkl'
