...
import scipy.io
from model_input.build_cross_input_mit4s_noFT import CNN_INPUT_cross, CNN_INPUT_cross_fine_tune, \
...
def evaluate(model, eval_iterator, params, epoch_i, run_mode='eval'):
    ...
    for i, (batch_x, batch_y) in enumerate(eval_iterator):
        ...
        batch_y = batch_y.long().to(device)
        # Forward pass to get output/logits
        #print("batch_x, batch_y",batch_x.shape,batch_y.shape)
...
if __name__ == '__main__':
    ...
    with torch.cuda.device(cuda_id):
        ...
        sub_seq_length = 10
        nb_of_sample, seq_dim, input_dim = 18099,100,21
        ...
        #best_pretrain_model_path = '/data/zzp/result/model_save/mit/resnet_scale0_epoch0of10_08031122.pkl'
